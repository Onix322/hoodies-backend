...
public class CartController {
    ...
    @GetMapping("get-item/{cartItemId}")
    public ResponseEntity<Response> getCartItemById(@PathVariable Long cartItemId){
        return ResponseHandler.ok(cartService.getCartItemById(cartItemId));
    }
